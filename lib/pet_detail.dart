...
import 'package:happy_pets/user_avatar.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      buildPetFeature("" + pet.months + " months", "Age"),
                      buildPetFeature("" + pet.color, "Color"),
                      buildPetFeature("" + pet.weight + " kg", "Weight"),
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16),
                  child: Text(
                    "He is nice in color and he is too healty",
                    style: TextStyle(
                      color: Colors.grey[600],
                      fontSize: 14,
                    ),
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: ()async{
                          ...
                          final _call= 'tel:${pet.usernumber}';
